...
import com.raystec.proj4.util.EmailBuilder;
import com.raystec.proj4.util.EmailMessage;
import com.raystec.proj4.util.EmailUtility;
...
public class UserModel {
	...
	public long add(UserBean bean) throws ApplicationException,
		...
		// System.out.println(existbean.getLogin());
		if (existbean != null) {
	...
	public void update(UserBean bean) throws ApplicationException,
		...
		System.out.println(beanExist.getId() == bean.getId());
	...
	public List list(int pageNo, int pageSize) throws ApplicationException {
		...
		log.debug("Mdel list Started");

		ArrayList list = new ArrayList();
		StringBuffer sql = new StringBuffer(
				"select * from ST_USER WHERE ROLE_ID=5");
	 ...
	 * @throws ApplicationException
	 */
	public List facultylist() throws ApplicationException {
		return facultyList(0, 0);
	}
	...
	public List facultyList(int pageNo, int pageSize)
			throws ApplicationException {
		log.debug("Model facultylist started ");
		ArrayList list = new ArrayList();
		StringBuffer sql = new StringBuffer(
				"SELECT * FROM ST_USER where ROLE_ID=5");
		...
		try {
			...
			throw new ApplicationException(
					" Exception : Exception in getting list of FacultyList");
